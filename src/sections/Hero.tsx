    ...
    <section className="pt-8 pb-20 md:pt-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip ">
      <div className="container">
        <div className="md:flex items-center ">
          ...
          <h1 className="text-5xl font-bold tracking-tighter md:text-7xl bg-gradient-to-b from-black to-[#001e80] text-transparent bg-clip-text mt-6">
          ...
          <Image src={noodleImage} width={220} alt="Noddle image" className=" hidden lg:block absolute top-[524px] left-[448px] rotate-[30deg]" />
          </div> 
        </div>
      </div>
    </section>
